<?php
/**
 * corporatemunk Portfolio Post Type
 *
...
function portfolio_post_type() {
	...
	$labels = array(
		'name'                => _x( 'Portfolios', 'Post Type General Name', 'corporate-munk' ),
		'singular_name'       => _x( 'Portfolio', 'Post Type Singular Name', 'corporate-munk' ),
		'menu_name'           => __( 'Portfolio', 'corporate-munk' ),
		'name_admin_bar'      => __( 'Portfolio', 'corporate-munk' ),
	...
	$args = array(
		'label'               => __( 'Portfolio', 'corporate-munk' ),
		'description'         => __( 'corporatemunk Portfolio', 'corporate-munk' ),
		'labels'              => $labels,
	...
	register_post_type( 'mu_portfolio', $args );
...
function portfolio_taxonomy() {
	...
	$labels = array(
		'name'                       => _x( 'Portfolio Categories', 'Taxonomy General Name', 'corporate-munk' ),
		'singular_name'              => _x( 'Portfolio Category', 'Taxonomy Singular Name', 'corporate-munk' ),
		'menu_name'                  => __( 'Portfolio Category', 'corporate-munk' ),
		'all_items'                  => __( 'All Items', 'corporate-munk' ),
	...
	register_taxonomy( 'mu_portfolio_category', array( 'mu_portfolio' ), $args );
